...
%>
    ...
    <div class="formbody">
	    ...
	    <form action="update_admin.jsp" class="forminfo">
	    	...
	    	<input type="hidden" name="admin_Level" value="<%=rs.getString(5) %>">
	    	<li><label>我的账户ID</label><input type="text" class="dfinput" value="<%=admin_ID %>" disabled class="form-control"/></li>
		    <li><label>我的姓名</label><input name="admin_Name" type="text" class="dfinput" value="<%=rs.getString(2) %>"/></li>
		    <li><label>我的性别</label>
		    	<cite>
		  	...
		  	<li><label>我的年龄</label><input name="admin_Age" type="text" class="dfinput" value="<%=rs.getInt(4) %>"/></li>
		    <li><label>我的岗位</label>
		    	<select class="dfinput" disabled>
					...
					<option <%="老板".equals(rs.getString(5)) ? "selected" : "" %>>老板</option>
				</select>
			</li>
