...
%>
    ...
    <div class="formbody">
	    ...
	    <form action="admin_update_pw_confirm.jsp" class="forminfo">
	    	<input type="hidden" name="admin_ID" value="<%=admin_ID %>">
	    	<li><label>我的账户ID</label><label><%=admin_ID %></label></li>
		    <li><label>当前密码</label><input name="admin_PW" type="password" class="dfinput" placeholder="请输入您的当前密码"/></li>
