...
%>
    ...
    <div class="reindex"><a href="que_admins.jsp" target="rightFrame" align="center">返回员工信息页</a></div>
    <div class="reindex"><a href="admin_update_info.jsp" target="rightFrame">返回我的信息</a></div>
