    ...
    <div class="rightinfo">
	    <div class="tools">
	    	<ul class="toolbar">
		        ...
		        <li><span><img src="<%=ctxPath%>/static/images/t04.png" /></span>统计</li>
	        </ul>
	        
	        <ul class="toolbar1">
	        	<li><span><img src="<%=ctxPath%>/static/images/t05.png" /></span>设置</li>
	        </ul>
	    </div>
	    ...
	    <table class="tablelist">
	    	<thead>
		    	<tr>
			        ...
			        <th>编号<i class="sort"><img src="<%=ctxPath%>/static/images/px.gif" /></i></th>
			        <th>标题</th>
			        <th>用户</th>
			        <th>籍贯</th>
			        <th>发布时间</th>
